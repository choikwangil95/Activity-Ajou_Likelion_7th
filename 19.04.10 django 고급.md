...
```
여기서 posts는 글 목록을 게시일 기준으로 정렬한 <storng>객체 (쿼리셋)</strong>이다.<br/>
...
#### 1) 기본 템플릿 생성하기
기본 템플릿은 웹사이트 내 모든 페이지에 확장되어 사용되는 가장 기본적인 템플릿
...
- 
해당 코드를 base.html파일 블럭부분에 사용할 것이다! 라고 말해준 것
